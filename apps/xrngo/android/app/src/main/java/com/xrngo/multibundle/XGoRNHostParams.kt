...
class XGoRNHostParams(val application: Application): RNHostParams() {
    ...
    override val getJSBundleFile: ((info: BundleInfo, isSplitMode: Boolean) -> String?)? = {info, isSplitMode ->
        "assets://index.${if (isSplitMode) COMMON_BUNDLE_NAME else info.bundleName}.bundle"
    }
