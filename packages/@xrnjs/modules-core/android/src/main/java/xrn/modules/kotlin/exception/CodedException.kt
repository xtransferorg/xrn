package xrn.modules.kotlin.exception

import com.facebook.react.bridge.ReadableType
import xrn.modules.core.interfaces.DoNotStrip
import java.util.*
...
inline fun Throwable?.toCodedException() = when (this) {
  ...
  is xrn.modules.core.errors.CodedException -> CodedException(this.code, this.message, this.cause)
