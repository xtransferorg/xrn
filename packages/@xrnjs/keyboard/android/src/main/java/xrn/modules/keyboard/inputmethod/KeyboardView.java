...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private KeyDrawListener mKeyDrawListener;

    /**
     * Key 绘制 回调
     * 用于对特定 key 有特殊 UI 绘制 （背景，字体大小，字体颜色等）
     */
     public interface KeyDrawListener {
        /**
         * 返回 Key 背景，如果返回 null，则不绘制背景，但是其他元素还是会绘制
         * @param key
         * @param defaultKeyBackground
         * @return
         */
        Drawable getKeyBackground(Keyboard.Key key, Drawable defaultKeyBackground);

        /**
         * 返回 Key 的 paint，用于修改和 paint 相关的元素（字体大小，颜色等）
         * @param key
         * @param paint
         * @return
         */
        Paint getPaint(Keyboard.Key key, Paint paint);
    }
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mBackgroundDimAmount = a.getFloat(0, 0.5f);
        a.recycle();
    ...
    public void setKeyDrawListener(KeyDrawListener listener) {
    ...
    private Drawable getKeyBackground(Keyboard.Key key, Drawable defaultKeyBackground) {
        return mKeyDrawListener == null ? defaultKeyBackground : mKeyDrawListener.getKeyBackground(key, defaultKeyBackground);
    }

    private Paint getKeyPaint(Keyboard.Key key, Paint paint) {
        return mKeyDrawListener == null ? mKeyDrawListener.getPaint(key, paint) : paint;
    }
...
//        final Drawable keyBackground = mKeyBackground;
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            final Drawable keyBackground = getKeyBackground(key, mKeyBackground);
            if (keyBackground != null) {
                ...
                final int localKeyWidth = Math.min(getMeasuredWidth() - getPaddingRight() - key.x - kbdPaddingLeft, key.width);
//                if (key.width != bounds.right ||
//                        key.height != bounds.bottom) {
                    keyBackground.setBounds(0, 0, localKeyWidth, key.height);
//                }
            ...
            if (label != null) {
                ...
                if (mKeyDrawListener != null) {
                    paint = mKeyDrawListener.getPaint(key, paint);
                }
                // Draw the text
    ...
    private boolean repeatKey() {
        if (mRepeatKeyIndex < 0 || mRepeatKeyIndex >= mKeys.length) {
            return false;
        }
