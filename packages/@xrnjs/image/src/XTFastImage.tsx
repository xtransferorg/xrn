...
export interface XTFastImageNativeProps extends Omit<ImageNativeProps, "source" | "placeholder"> {
...
class XTFastImage extends React.PureComponent<XTFastImageNativeProps> {
    ...
    onError = () => {
        const error: ImageErrorEventData = { error: "harmony use fast-image, it has not detail error info!" }
    ...
    render() {
        const { style, accessibilityLabel, alt, nativeViewRef, ...props } = this.props;
