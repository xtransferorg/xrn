...
import xrn.modules.image.events.GlideRequestListener
import xrn.modules.image.events.OkHttpProgressListener
...
import xrn.modules.kotlin.tracing.beginAsyncTraceBlock
...
class ExpoImageViewWrapperReal(context: Context, appContext: AppContext) :
    ExpoImageViewWrapper(context, appContext) {
    ...
    private fun createPropOptions(): RequestOptions {
        return RequestOptions()
            .priority(this@ExpoImageViewWrapperReal.priority.toGlidePriority())
        ...
        trace(
            ...
            val request = requestManager
                ...
                .customize(bestPlaceholder, placeholder) { placeholderSource, placeholderModel ->
                    val newPlaceholderContentFit =
                        if (!placeholderSource.usesPlaceholderContentFit()) {
                            contentFit
                        } else {
