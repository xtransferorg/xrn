...
import com.facebook.react.viewmanagers.XRNImageViewManagerDelegate
import com.facebook.react.viewmanagers.XRNImageViewManagerInterface
...
class XRNImageViewManager : XRNBaseImageViewManager<ExpoImageViewWrapper>(),
    XRNImageViewManagerInterface<ExpoImageViewWrapper> {

    private val mDelegate = XRNImageViewManagerDelegate(this)

    override fun getDelegate(): ViewManagerDelegate<ExpoImageViewWrapper?>? {
        return mDelegate
    }
    ...
    override fun setSource(view: ExpoImageViewWrapper, sources: ReadableArray?) {
        view.sources = toImageSources(sources)
    }

    @ReactProp(name = "contentFit")
    override fun setContentFit(view: ExpoImageViewWrapper, contentFit: String?) {
        view.contentFit = fromValue<ContentFit>(contentFit, ContentFit.Cover) { it.value }
    }

    @ReactProp(name = "placeholderContentFit")
    override fun setPlaceholderContentFit(
        view: ExpoImageViewWrapper,
    ...
    override fun setContentPosition(view: ExpoImageViewWrapper, contentPosition: ReadableMap?) {
        if (contentPosition == null) return
    ...
    override fun setBlurRadius(view: ExpoImageViewWrapper, blurRadius: Int) {
        view.blurRadius = blurRadius
    }

    @ReactProp(name = "transition")
    override fun setTransition(view: ExpoImageViewWrapper, transition: ReadableMap?) {
    ...
    override fun setTintColor(view: ExpoImageViewWrapper, tintColor: Int?) {
        view.tintColor = tintColor
    }

    @ReactProp(name = "placeholder")
    override fun setPlaceholder(view: ExpoImageViewWrapper, placeholder: ReadableArray?) {
        view.placeholders = toImageSources(placeholder)
    }

    @ReactProp(name = "accessible")
    override fun setAccessible(view: ExpoImageViewWrapper, accessible: Boolean) {
    ...
    override fun setFocusable(view: ExpoImageViewWrapper, focusable: Boolean) {
        view.isFocusableProp = focusable
    }

    @ReactProp(name = "priority")
    override fun setPriority(view: ExpoImageViewWrapper, priority: String?) {
        view.priority = fromValue<Priority>(priority, Priority.NORMAL) { it.value }
    }

    @ReactProp(name = "cachePolicy")
    override fun setCachePolicy(view: ExpoImageViewWrapper, cachePolicy: String?) {
        view.cachePolicy = fromValue<CachePolicy>(cachePolicy, CachePolicy.DISK) { it.value }
    }

    @ReactProp(name = "recyclingKey")
    override fun setRecyclingKey(view: ExpoImageViewWrapper, recyclingKey: String?) {
        view.recyclingKey = recyclingKey
    }

    @ReactProp(name = "allowDownscaling")
    override fun setAllowDownscaling(view: ExpoImageViewWrapper, allowDownscaling: Boolean) {
        view.allowDownscaling = allowDownscaling
    }

    @ReactProp(name = "autoplay")
    override fun setAutoplay(view: ExpoImageViewWrapper, autoplay: Boolean) {
        view.autoplay = autoplay
    }

    @ReactProp(name = "decodeFormat")
    override fun setDecodeFormat(view: ExpoImageViewWrapper, decodeFormat: String?) {
        view.decodeFormat =
