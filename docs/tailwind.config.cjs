  ...
  ...getExpoTheme(
    {
      backgroundImage: theme => ({
        ...
        'cell-quickstart-pattern': "url('/xrn/static/images/home/QuickStartPattern.svg')",
        'cell-tutorial-fade': `linear-gradient(var(--blue3) 15%, #201d5200 100%)`,
        'cell-tutorial-pattern': "url('/xrn/static/images/home/TutorialPattern.svg')",
        appjs: "url('/xrn/static/images/appjs.svg'), linear-gradient(#0033cc, #0033cc)",
      }),
      keyframes: {
        fadeIn: {
          '0%': {
