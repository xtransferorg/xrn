...
export const getRoutes = (
  ...
  if (isReferencePath(path)) {
    ...
    return navigation[sec as unknown as keyof typeof navigation] as NavigationRoute[];
  }
};
...
export const isResourcesPath = (path: string) => {
  return navigation.resourcesDirectories.some(name => Utilities.pathStartsWith(name, path));
};
