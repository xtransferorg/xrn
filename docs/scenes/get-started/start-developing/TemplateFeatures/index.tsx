    ...
    <div className="text-default rounded-md overflow-hidden border border-default">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[250px_minmax(0,_1fr)]">
        ...
        <div className="bg-default">
          {selected === 'navigation' ? (
            <Content
              imgSrc="/xrn/static/images/get-started/navigation.png"
              darkImgSrc="/xrn/static/images/get-started/navigation-dark.png"
          ...
          {selected === 'platforms' ? (
            <Content
              imgSrc="/xrn/static/images/get-started/platforms.png"
              darkImgSrc="/xrn/static/images/get-started/platforms-dark.png"
          ...
          {selected === 'images' ? (
            <Content
              imgSrc="/xrn/static/images/get-started/images.png"
              darkImgSrc="/xrn/static/images/get-started/images-dark.png"
          ...
          {selected === 'fonts' ? (
            <Content
              imgSrc="/xrn/static/images/get-started/fonts.png"
              darkImgSrc="/xrn/static/images/get-started/fonts-dark.png"
          ...
          {selected === 'themes' ? (
            <Content
              imgSrc="/xrn/static/images/get-started/themes.png"
          ...
          {selected === 'animations' ? (
            <Content
              imgSrc="/xrn/static/images/get-started/animations.png"
              darkImgSrc="/xrn/static/images/get-started/animations-dark.png"
